...
<div style="padding-top:7%" class="container-fluid"> 
    <nav class="navbar navbar-default navbar-fixed-top"> 
        <ul class="list-inline nav navbar-nav navbar-right">
            ...
            <li><div class="navbar-text" id="carshop" style="font-size:12pt;margin-left:0px;margin-right:0px;"> {{$totalItems}}</div></li> 
...
@foreach($products as $product) 
    @if ($j==0) <div class='row'> @endif 
        <div class="col-sm-4"> 
            ...
            <div class="panel-heading" style="background: #555; color: white">{{ $product->name }} {{ $product->description }}</div> 
...
$(".bth,.addItem").click(function() {
    var total = parseInt($('#carshop').text());
    var i=$(this).val();
    $('#carshop').text(total);    
    $.ajax({
      type: "get",
